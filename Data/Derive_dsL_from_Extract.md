...
After renaming the variables, we arrange data in a initial wide format (variable-occasions as columns), arriving at the basis dataset **dsSource**, which contains 
