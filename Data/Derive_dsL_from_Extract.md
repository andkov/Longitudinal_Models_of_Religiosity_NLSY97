...
After renaming the variables, we arrange data in a initial wide format, arranging these variables horizontaly, arriving at the basis dataset **dsSource**, which contains 
...
### Factor labels
We do not convert categorical variables into factors with assigned levels yet. Factor labels will be applied separetely before each  modeling exercise to prevent using an adulterated or misunderstood datasource.
