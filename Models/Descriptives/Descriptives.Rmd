...
print(ds[ds$id==1,]) 
```
Script [LabelingFactorLevel](https://github.com/andkov/Longitudinal_Models_of_Religiosity_NLSY97/blob/master/Manipulation/LabelingFactorLevels.R) loads the definitions of the factor levels that can be applied to retained variables. 
```{r,echo=FALSE}
# print (dsL[dsL$id==1,c("id","year","attend")]) # print [ rows, columns/variables]
