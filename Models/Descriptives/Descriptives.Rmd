...
pathPNG <- base::file.path(pathImageOut,"agemon")
years <- 1997:2000
pgnNum<-c(1:length(years))
...
for (year in years){
  ...
  pathPNGnum <- paste0(pathPNG,year,".png")
  pathPNGnew <- base::gsub(pattern=pngNum, replacement=year, x=pathPNGnum)
