...
```{r, echo=echoChunks, message=T, out.width="700px", fig.width = 8}
...
However, its resolution allows us to treat it as continuous for the purpose of fitting statistical models. 
```{r , echo=T, message=F, results='hold'}
ds<-(subset(dsL, year==2000)) # select obs for year 2000
summary(ds$attend) # summarize as continuous variable
```

To map church attendance to time, let's select a manageble dataset that would include personal identifyer (**id**), cohort indicator (**byear**), wave of measurement (**year**) and the focal variable of interest - worship attendance (**attend**). 
