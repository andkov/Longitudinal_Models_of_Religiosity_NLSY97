...
```{r attend_2000, echo=echoChunks, message=T, out.width="300px", fig.width = 8}
...
```{r attend_2000_2011,echo=echoChunks, message=F, out.width="300px", fig.width = 8 }
...
```{r attend_2000_2011_na,echo=F, message=F, out.width="300px", fig.width = 8 }
ds<- dsL
...
```{r,echo=echoChunks, message=F, out.width="300px", fig.width = 8, warning=warningChunks }
