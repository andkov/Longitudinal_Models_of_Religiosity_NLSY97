...
Assumming that attrition is not significantly associated with  the outcome measure, we can remove missing values from the calculation of the total of responses and at look at percentages that each response was endorsed at each time point. 
```{r attend_2000_2011_na,echo=echoChunks, message=F, out.width="700px", fig.width = 8 }
# attcol8 is defined in DeclareGlobal chunk of  the .R file
ds<- dsL
