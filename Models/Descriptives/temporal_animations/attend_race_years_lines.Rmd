...
#   fig.width = 6.5, 
  out.width = NULL,
  fig.path = 'Attend_Race_Years_Lines/',     
  dev = "png",
  dpi = 100
)
echoChunks <- FALSE
...
```{r attend_race_2000, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2000
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```

## Attendance among races in 2001
```{r attend_race_2001, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2001
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2002, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2002
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2003, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2003
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2004, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2004
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2005, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2005
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2006, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2006
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2007, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2007
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2008, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2008
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2009, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2009
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2010, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2010
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
...
```{r attend_race_2011, echo=F, message=F, warning=F, fig.height=7, fig.width=10}
t<- 2011
source(file.path(getwd(),"Models/Descriptives/temporal_animations/commonGraph_race_years_Lines.R"))
p
```
