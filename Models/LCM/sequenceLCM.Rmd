...
table(ds$year) # number of respondents in each round of NLSY97
table(ds$age) # number of respondents in each agea bin
d<- ds %>% 
...
length(unique(ds$timec)) # number of time points
```
