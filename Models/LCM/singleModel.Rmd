...
# dsp$gamma01<- FE["timec"]*dsp$timec 
# ifelse( is.na(FE["timec"]) , 0, FE["timec"]*dsp[,"timec"]) 
# ifelse( is.na(rep(FE["timec"],nrow(dsp))) , 0, FE["timec"]*dsp[,"timec"]) 
# ifelse( is.na(rep(FE["time"],nrow(dsp))) , 0, FE["time"]*dsp[,"time"]) 
# ifelse( is.na(FE["time"]) , 0, c(3,2,5)) 
...
#   # Linear trend of time - gamma sub(11)    
# dsp$gamma11<- FE["timec:cohort"]*dsp$timec
#   # Quadratic trend of time - gamma sub(12)
# dsp$gamma12<- FE["timec2:cohort"]*dsp$timec2
  # Cubic trend of time - gamma sub(13) 
# dsp$gamma10<-  FE["timec3:cohort"]*dsp$timec3
 # Linear trend of time - gamma sub(11) 
